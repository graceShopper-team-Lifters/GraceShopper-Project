  ...
  return (
    ...
    >
      <a href="https://www.facebook.com" style={{ margin: '60px' }}>
        <img src="https://www.freepnglogos.com/uploads/facebook-icons/facebook-logos-15.png" alt="Facebook" style={{ width: '30px', height: '30px' }} />
      </a>
      <a href="https://www.twitter.com" style={{ margin: '60px' }}>
        <img src="https://cdn.freebiesupply.com/logos/large/2x/twitter-3-logo-png-transparent.png" alt="Twitter" style={{ width: '30px', height: '30px' }} />
      </a>
